...
class NumSorter {
  ...
  */
  ...
  // this.numList.length++; // Increase the length of the list
  // if (!this.numList.length) {
  //   this.numList.head = node;
  //   this.numList.tail = node
  // } else {
  //   console.log(this.numList.head)
  //   let current = this.numList.head;
  //   // console.log(this.numList.head)
  //   while (current !== null) {
  //     current = current.next;
  //   }
