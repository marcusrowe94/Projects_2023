...
// const createButton = () => {
    ...
    squareOne.innerText = ""
    squareOne.appendChild(buttonOne);
...
const allSquares = document.querySelector(".square.plus")
allSquares.style.width = "100px"
allSquares.style.fontSize = "60px"
// Your code here
...
root.removeChild(root.childNodes[10])
root.removeChild(root.childNodes[11])
