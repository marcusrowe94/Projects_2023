...
(() => {
  ...
  describe('Exercises in Recursion', () => {

    describe('1. Factorial', () => {
      let originalFactorial;
      let factorial;

      before(() => {
        originalFactorial = req.factorial;
        factorial = req.factorial;
      });

      afterEach(() => {
        factorial.resetHistory();
      });

      after(() => {
        req.factorial = originalFactorial;
      });
      ...
      it('should return factorial for non-negative integers', () => {
      ...
      it('should use recursion by calling itself', () => {
        factorial(4);
        expect(factorial.callCount).to.be.greaterThan(1);
      });

      it('should be invoked with one argument', () => {
        factorial(4);
    ...
    describe('2. Sum of Integers', () => {
      let originalSum;
      let sum;

      before(() => {
        originalSum = req.sum;
        sum = req.sum = sinon.spy(req.sum);
      });
      ...
      it('should return the sum of an array of non-negative integers', () => {
