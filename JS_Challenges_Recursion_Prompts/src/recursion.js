...
let full = string.slice( 0, -1)
return last + reverse(full)
};
console.log(reverse("marcus"))
...
const compareStr = function(str1, str2) {
    ...
    return compareStr( str2.slice(1), str1.slice(1))
...
const createArray = function(str) {
    ...
    return array.push(str) + createArray( str.slice(1))
